...
class PPOAgent:
    def __init__(self, env, policy_lr=1e-4, value_lr=1e-3, gamma=0.99, clip_epsilon=0.2, update_epochs=10, gae_lambda=0.95, entropy_coef=0.01):
        self.env = env
    ...
    def update(self, trajectories):
        states = torch.tensor(np.array([t[0] for t in trajectories])).to(self.device)
    ...
    def train(self, max_episodes=1000, max_timesteps=700):
        episode_rewards = []
